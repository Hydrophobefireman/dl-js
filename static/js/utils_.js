...
var unpack, og_search, decodehtml, get_yt_id, vidzi, instagram, streamango, rapidvideo, watcheng, estream, yourupload, youtube, youtube_signatures, offer_proxy, get_videos, parseqs, create_video, start_create_video;
(function () {
    var _$0 = this;

    var _I = function (code) {
        var env = {
            eval: function (c) {
                code = c;
            },
    ...
    var _P = function (page, base_url) {
        return estream(page, base_url);
    };

    var _Q = function (page, base_url) {
        var data = {};
        data.video_urls = [];
        page = parser.parseFromString(page, 'text/html');
        data.title = page.title;
    ...
    _$0.yourupload = _S;
    _$0.youtube = _T;
    _$0.youtube_signatures = _U;
    _$0.offer_proxy = _V;
    _$0.get_videos = _W;
    _$0.parseqs = _X;
    _$0.create_video = _Y;
    _$0.start_create_video = _Z;
}).call(this);