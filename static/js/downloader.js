...
const analyse_perf = (b, c) => {
    const d = document.getElementById("analysed-data"), e = document.getElementById("dl_time"), f = document.getElementById("dl_speed"), a = (c / 1E3).toFixed(2), g = (b / 1048576 / a).toFixed(2);
    e.innerHTML = a;
    f.innerHTML = g;
